...
class mlir_aie_python_tagged_int32_to_int64(gr.basic_block):
    """
    docstring for block mlir_aie_python_tagged_int32_to_int64
    """
    def __init__(self):
        gr.basic_block.__init__(self,
            name="mlir_aie_python_tagged_int32_to_int64",
