module {
  aie.device(npu2) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @passthrough_fn(%in_cons_buff_0, %out_buff_0, %c4096_i32) : (memref<4096xi8>, memref<4096xi8>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock_0, Release, 1)
      aie.use_lock(%out_cons_lock_0, Release, 1)
      aie.use_lock(%out_prod_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%in_cons_cons_lock_0, AcquireGreaterEqual, 1)
      func.call @passthrough_fn(%in_cons_buff_1, %out_buff_1, %c4096_i32) : (memref<4096xi8>, memref<4096xi8>, i32) -> ()
      aie.use_lock(%in_cons_prod_lock_0, Release, 1)
      aie.use_lock(%out_cons_lock_0, Release, 1)
