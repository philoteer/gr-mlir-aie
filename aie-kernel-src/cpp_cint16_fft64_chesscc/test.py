...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, .99, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.mlir_aie_complex64_to_cint16_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.blocks_vector_to_stream_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.fft_vxx_0, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.mlir_aie_cint32_to_complex64_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.mlir_aie_complex64_to_cint16_0, 0), (self.mlir_aie_mlir_aie_cpp_int32_to_int64_0, 0))
        self.connect((self.mlir_aie_mlir_aie_cpp_int32_to_int64_0, 0), (self.mlir_aie_cint32_to_complex64_0, 0))
